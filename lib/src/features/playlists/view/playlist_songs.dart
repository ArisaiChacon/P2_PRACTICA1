...
import '../../../shared/views/hoverable_song_play_button.dart'; // Asegúrate de importar HoverableSongPlayButton

class PlaylistSongs extends StatelessWidget {
  const PlaylistSongs({super.key, required this.playlist, required this.constraints});
